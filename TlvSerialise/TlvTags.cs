namespace TlvSerialise
{
    public enum TlvTags
    {
        ...
        ID_RESTRICTION_SD_CF_MKR = 6756,
        ID_RESTRICTION_SD_CODE = 6757,
        ID_RESTRICTION_SD_TRAIN_NO = 6758,
        ID_RESTRICTION_SD_OUT_RET = 6759,
        ID_RESTRICTION_SD_DATE_FROM = 6760,
        ID_RESTRICTION_SD_DATE_TO = 6761,
        ID_RESTRICTION_SD_DAYS = 6762,
