...
namespace TlvProto
{
    ...
    {
        [Tlv(TlvTypes.Int, TlvTags.ID_QCKSEL_CODE)]public int Code { get; set; }
...
//        [Tlv(TlvTypes.Int, TlvTags.ID_QCKSEL_ADULT_FARE)]
        public int AdultFare { get; set; }
//        [Tlv(TlvTypes.Int, TlvTags.ID_QCKSEL_CROSS_LONDON_IND)]
        public int CrossLondonInd { get; set; }
//        [Tlv(TlvTypes.Int, TlvTags.ID_QCKSEL_FLAG)]
        public int Flag { get; set; }
//        [Tlv(TlvTypes.String, TlvTags.ID_QCKSEL_RESTRICTION)]
        public string Status { get; set; }
//        [Tlv(TlvTypes.Int, TlvTags.ID_QCKSEL_ORIENTATION)]
